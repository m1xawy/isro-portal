...
@section('content')
    <div class="space-y-6">
        <div class="lg:flex lg:flex-wrap">
            ...
            <a href="javascript:void(0)" data-link="{{ route('ranking.job') }}" class="ranking-main-button text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:outline-none dark:focus:ring-indigo-800">Job Ranking</a>
            <a href="javascript:void(0)" data-link="{{ route('ranking.honor') }}" class="ranking-main-button text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:outline-none dark:focus:ring-indigo-800">Honor Ranking</a>
            ...
            <a href="javascript:void(0)" data-link="{{ route('ranking.unique.monthly') }}" class="ranking-main-button text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:outline-none dark:focus:ring-indigo-800">Unique Ranking (Monthly)</a>
