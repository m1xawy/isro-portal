                                ...
                                <div class="ml-4">
                                    ...
                                    <ul class="character-build flex flex-row mt-3">
                                        @foreach($charBuildInfo as $build)
                                            <li><img src="{{ asset('images/ingame/skillmastery/'. config('global.skill_mastery')[$build->MasteryID]['icon']) }}" title="{{ config('global.skill_mastery')[$build->MasteryID]['name'] }}"></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4" style="color: #ffc345">
                                        ...
                                        @php if($characters->HwanLevel > 0) : @endphp
                                            {{ config('global.hwan_titles')[$race][$characters->HwanLevel] }}
                                        @php endif; @endphp
                                        ]
                                    </td>
                                </tr>
