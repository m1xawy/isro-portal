@if (nova_get_setting('breadcrumb_enable') !== null && nova_get_setting('breadcrumb_enable'))
    <header
        ...
        style="background-image: url({{ asset(Storage::url(nova_get_setting('color_background_image', ''))) }})">
