...
<meta property="og:site_name" content="{{ setting('server_name', config('app.name', 'Laravel')) }}"/>
<meta property="og:title" content="{{ setting('server_name', config('app.name', 'Laravel')) }} - @yield('title')" />
