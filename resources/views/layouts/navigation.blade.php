                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ url('/') }}">
                        @if (nova_get_setting('server_logo'))
                            <img src="{{ asset(Storage::url(nova_get_setting('server_logo', ''))) }}" class="w-40 mr-0"
                                 alt="{{ nova_get_setting('server_name', config('app.name', 'Laravel')) }}">
                        @else
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @if (Route::has('login'))
                    ...
                    @else
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <a href="{{ route('login') }}"
                               class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">{{ __('Log in') }}</a>
                        </div>
                        <div class="hidden sm:flex sm:items-center">
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}"
                                   class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">{{ __('Register') }}</a>
                            @endif
                        </div>
                    @endauth
                @endif
